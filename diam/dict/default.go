...
<diameter>
    ...
    <!-- Diameter Common Messages -->
		...
		<avp name="TMGI-Allocation-Request" code="3509" vendor-id="10415" must="V" may="M" may-encrypt="N">
			<data type="Grouped">
		...
		<avp name="TMGI-Deallocation-Request" code="3512" vendor-id="10415" must="V" may="M" may-encrypt="N">
			<data type="Grouped">
				<rule avp="TMGI" required="false" max=""/>
			</data>
		</avp>
    ...
    <application id="16777251" type="auth" name="TGPP S6A">
        ...
        <command code="319" short="ID" name="Insert-Subscriber-Data">
            ...
            <answer>
                ...
                <rule avp="Supported-Services" required="false" max="1" />
        ...
        <avp name="IDR-Flags" code="1490" must="V" must-not="M" may-encrypt="N" vendor-id="10415">
            <data type="Unsigned32"/>
        </avp>
